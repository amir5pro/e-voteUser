...
const PreVoteDate = () => {
  ...
  const onFinish = async (values) => {
    ...
    setLoading(true);
    try {
      await customFetch.post("/admin/preliminaryVoteDate", dateRangeObject);
      toast.success(" successfully added preliminary voting date");
      setLoading(false);
      form.resetFields();
    } catch (error) {
      setLoading(false);
