...
const VoterRegDate = () => {
  ...
  const onFinish = async (values) => {
    ...
    setLoading(true);
    try {
      await customFetch.post("/admin/voterRegistrationDate", dateRangeObject);
      toast.success(" successfully added voter Registration Date");
      setLoading(false);
      form.resetFields();
    } catch (error) {
      setLoading(false);
